...
export const V3_FIXTURE_BASE_COMMIT = "17b7a92401c715448c7a195fa5a973bd52498eed";
export const V3_SCHEMA_MANIFEST_SHA256 =
  "c11246dd8077614523611f504418562e16b7da767f98804e9dfade2c763961ea";

export const V3_SCHEMA_SQL = `PRAGMA foreign_keys = ON;
...
export function createLegacyV3Database(options?: { readonly path?: string }): DatabaseSync {
