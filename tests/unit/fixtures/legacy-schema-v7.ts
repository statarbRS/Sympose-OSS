...
export const DDL = `${V7_BASE_DDL}\n${V5_DDL}\n${V6_DDL}\n${V7_DDL}`;

export const V7_FIXTURE_BASE_COMMIT = "75a3429cf87db77fffa174622790a3723a91b3be";
export const V7_SCHEMA_MANIFEST_SHA256 = "482077774bab4591c6ecc1761f5eaaf8152029a0d23e973277bf6f0c957eb360";

export function createLegacyV7Database(options?: { readonly path?: string }): DatabaseSync {
